...
/** This class implements a light timer. It is used to control the timeouts associated with
 * a given light. */
			...
			t = new Thread(new Runnable() {
				...
				public void run() {
					while(mydelay != 0) {
						...
						callback.signalAction(LightControllerCommandInterface.LAMP_TIMER_EXPIRED);
					}
				}
			});
			t.start();
