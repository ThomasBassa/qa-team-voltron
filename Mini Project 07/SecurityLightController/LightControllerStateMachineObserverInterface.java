...
/** This interface defines an interface which a class must implement if it desires to
 * observe the lamp state. */
public interface LightControllerStateMachineObserverInterface {
	 ...
	 * @param newState The new state, one of LAMP_OFF_DAYLIGHT , LAMP_ON_FULL_BRIGHTNESS,
	 *        LAMP_OFF_NIGHTIME, LAMP_ON_NIGHTIME_BRIGHTNESS, MOTION_DETECTED,
